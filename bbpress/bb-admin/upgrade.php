...
?>
		<p class="last">
			<?php printf( __('Nothing to upgrade.  <a href="%s">Get back to work!</a>'), bb_get_uri('../../../../wp-admin/admin.php?page=bpsmf_admin_settings', null, BB_URI_CONTEXT_A_HREF + BB_URI_CONTEXT_BB_ADMIN) ); ?>
		</p>
<?php
		break;
...
?>
		<div class="open">
			...
			<div>
				<form action="<?php bb_get_uri('../../../../wp-admin/admin.php?page=bpsmf_admin_settings', null, BB_URI_CONTEXT_A_HREF + BB_URI_CONTEXT_BB_ADMIN); ?>" method="get">
					<p class="message">
